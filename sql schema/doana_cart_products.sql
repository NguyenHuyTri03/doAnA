...
CREATE TABLE `cart_products` (
  ...
  KEY `FKh72x9g1expjjcnyxglwhbv4xu` (`product_id`),
  KEY `FKbilp3o9irlsvmbot68kfpthom` (`cart_id`),
  CONSTRAINT `FKbilp3o9irlsvmbot68kfpthom` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`),
  CONSTRAINT `FKh72x9g1expjjcnyxglwhbv4xu` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `cart_products` VALUES (1,1);
